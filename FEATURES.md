...
| **Sofortverlosung** | Keyword im Zeitfenster — sonst nichts (kein Follow, keine Zuschauzeit; Anwesenheit des Gezogenen prüft der Streamer live) | gleich für alle | Anmeldefenster 10 s – 1 h, mehrfach öffenbar; Ziehung macht der Streamer selbst (★) nach dem Schließen; Chat-Ansagen je Instanz schaltbar (Default an, Gewinner-Ansage immer) |
